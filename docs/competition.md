...
### ZipLLM, measured head-to-head rather than compared across corpora

Qwen2.5-0.5B base plus four full fine-tunes, 4.941 GB BF16, identical pipelines
differing only in the final coder:
...
- **Dedup found 0.00% of this corpus** — ninety-five tensors matched the base
  exactly and they were norms and biases totalling 0.1 MB. ZipLLM's hub gets 8.3%
  from dedup because it is 99.64% fine-tunes with near-duplicate uploads. Dedup
